...
There's a problem with this however. The integration tests have to run on an Android device/emulator, but the Firebase emulators aren't built to run in Android. They assume a desktop/server OS.
